...
public class SuiteVerificators {
    ...
    public void numberLongWithCombinationsVerificatorCheck() {
        ...
        Assert.assertFalse(verificator.isLessThen(10));
        Assert.assertTrue(verificator.isLessThenOrEquals(10.0));
        Assert.assertTrue(verificator.isLessThen(11));
        Assert.assertFalse(verificator.isGreaterThen(11));
        Assert.assertTrue(verificator.isGreaterThenOrEquals(10));
        Assert.assertFalse(verificator.isGreaterThen(10));
    ...
    public void numberDoubleVerificatorCheck() {
        ...
        NumberVerificator verificator = new DefaultNumberVerificator(10.5);
        Assert.assertFalse(verificator.isNull());
        Assert.assertTrue(verificator.isNotNull());
        ...
        Assert.assertTrue(verificator.isNot(9L));
        Assert.assertFalse(verificator.isLessThen(10));
        Assert.assertTrue(verificator.isLessThenOrEquals(10.5));
        Assert.assertTrue(verificator.isLessThen(11));
        Assert.assertFalse(verificator.isGreaterThen(10.6));
        Assert.assertTrue(verificator.isGreaterThenOrEquals(10.5));
        Assert.assertFalse(verificator.isGreaterThen(10.5));
    ...
    @Test
    public void numberCollectionVerificatorCheck() {
        Integer[] array = new Integer[]{1,2,3,4,5};
        
        CollectionVerificator verificator = new NumberCollectionVerificator(array);
        ...
        list.add(4);
        list.add(5);
        verificator = new NumberCollectionVerificator(list);
        
        Assert.assertTrue(((NumberCollectionVerificator)verificator).plus(10).hasAny(11,12));
        Assert.assertFalse(((NumberCollectionVerificator)verificator).plus(10).hasAny(2,3,4,5));
        
        Assert.assertTrue(((NumberCollectionVerificator)verificator).minus(10).hasOnly(-9,-8,-7,-6,-5));
        Assert.assertFalse(((NumberCollectionVerificator)verificator).minus(10).hasAny(2,3,4,5));
        
        Assert.assertTrue(((NumberCollectionVerificator)verificator).multiply(10).hasExactly(10,20,30,40,50));
        Assert.assertTrue(((NumberCollectionVerificator)verificator).multiply(10).divide(2).hasExactly(5,10,15,20,25));
        
        Assert.assertTrue(((NumberCollectionVerificator)verificator).mod(2).hasExactly(1%2,2%2,3%2,4%2,5%2));
    ...
    public void textCollectionVerificatorCheck() {
        TextCollectionVerificator verificator= new TextCollectionVerificator("One","Two","Three","Four","Five");
